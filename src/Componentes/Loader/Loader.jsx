...
let HTML_easy = [
      {
          ...
          alternativa_A:'Hypertext Model Language',
          alternativa_B:'Hypertext Markdown Language',
          alternativa_C:'Hypertext Markup Language',
      ...
      },
      {
          ...
          alternativa_A:'Define a lista de itens em uma página',
          ...
          alternativa_D:'Define o conteúdo principal da página',
          resposta:'d',
      ...
      },
      {
          ...
          alternativa_B:'Define um parágrafo de texto',
      ...
      },
      {
          ...
          alternativa_A:'Define uma seção de cabeçalho para um documento ou seção',
          alternativa_B:'Define uma lista não ordenada',
          alternativa_C:'Define uma lista de itens em uma tabela',
          alternativa_D:'Define uma lista ordenada',
          resposta:'d',
          tema:'Tag <ol> em HTML'
      },
      {
          ...
          alternativa_A:'Define uma imagem em uma página',
          alternativa_B:'Define um link para outra página ou recurso',
          alternativa_C:'Define uma tabela em uma página',
      ...
      },
      {
          ...
          alternativa_A:'Define uma lista de itens',
          alternativa_B:'Define um formulário para entrada de dados do usuário',
          alternativa_C:'Define um parágrafo de texto',
